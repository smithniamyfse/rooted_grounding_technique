...
//             // Check if there's an existing unassociated event entry for the user
//             const existingEventResult = await connection.query(
//                 `SELECT "id" FROM "user_event_entries" WHERE "user_id" = $1 AND "id" NOT IN (SELECT "event_id" FROM "user_images") LIMIT 1;`,
//                 [userId]
//             );
...
//                 const eventInsertResult = await connection.query(
//                     `INSERT INTO "user_event_entries" ("location", "date", "time", "user_id") VALUES (NULL, CURRENT_DATE, CURRENT_TIME, $1) RETURNING "id";`,
//                     [userId]
//                 );
//                 eventId = eventInsertResult.rows[0].id;
//             }

//             // Insert the image and link it to the event entry
//             await connection.query(
//                 `INSERT INTO "user_images" ("image_url", "user_id", "user_event_id") VALUES ($1, $2, $3);`,
//                 [imageUrl, userId, eventId]
//             );
...
// router.post(
//   "/upload",
//   rejectUnauthenticated, async
//   (req, res, next) => {
//     const token = req.body.token;
//     if (receivedTokens.includes(token)) {
