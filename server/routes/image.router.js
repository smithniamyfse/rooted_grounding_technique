...
router.post(
  ...
  (req, res) => {
    ...
    pool
      .query(queryTextImage, queryParamsImage)
      .then((imageInsertResult) => {
        ...
        return [imageId, pool.query(queryTextEvent, queryParamsEvent)];
      })
      .then(([imageId, eventInsertResult]) => {
        ...
        return pool.query(queryTextUpdate, queryParamsUpdate);
      })
      .then(() => {
        res.sendStatus(200);
      })
...
router.get("/:imageId", rejectUnauthenticated, (req, res) => {
...
// ** PREVIOUS VERSION BEFORE CONVERSION **
// const express = require("express");
// const router = express.Router();
// const multer = require("multer");
// const multerS3 = require("multer-s3");
